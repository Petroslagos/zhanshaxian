  ...
  renderShareCard() {
    ...
    if (coins.solidus !== undefined) {
      coinsHtml = `
        ...
        <div class="share-summary-item"><span>特雷米西斯(1/2索里独斯)</span><span>${Calculator.formatNumber(coins.tremissis)}</span></div>
      `;
    } else {
      coinsHtml = `
    ...
    const comparisonsHtml = status.comparisons.slice(0, 3).map(c => `
      <div class="share-summary-item">
    ...
    document.getElementById('share-card').innerHTML = `
      ...
      <div class="share-section">
        ...
        ` : `
          <div class="share-summary-item"><span>黄金</span><span>${Calculator.formatNumber(result.input.gold_g)}g</span></div>
